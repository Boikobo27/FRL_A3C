...
from mr.mobile_env.core.custom_logging import Monitor
...
class MComCore(gym.Env):
    ...
    def __init__(self, stations, users, config={}):
        ...
        self.utilities_scaled: Dict[UserEquipment, float] = None
    ...
    def reset(self):
        ...
        # reset UEs' utilities
        self.utilities = {}
        self.utilities_scaled = {}
        self.utilities_float = []
        self.utilities_scaled_float = []
    ...
    #def reset(self):
        #just to bypass reset in loop and changed main "def reset(self)" to "def reset_t0(self)"
        #pass
    ...
    def step(self, actions: Dict[int, int]):
        ...
        #print('self.utilities in step=', self.utilities)
        #print('np.array(self.utilities) in step=', np.array(self.utilities))
        self.utilities_float = [utility for utility in self.utilities.values()]
        #print('self.utilities_float=', self.utilities_float)
        
        self.utilities_float_mean = statistics.mean(self.utilities_float)
        #print('self.utilities_float_mean=', self.utilities_float_mean)
        ...
        self.utilities_scaled_float = [utility for utility in self.utilities_scaled.values()]
        #print('self.utilities_scaled_float=', self.utilities_scaled_float)
        
        self.utilities_scaled_float_mean = statistics.mean(self.utilities_scaled_float)
        #print('self.utilities_scaled_float_mean=', self.utilities_scaled_float_mean)        
        ...
        #self.done = True if rewards > 0 else False
